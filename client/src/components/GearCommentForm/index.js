...
import { ADD_GEAR_COMMENT } from '../../utils/mutations';

const GearCommentForm = ({ gearId }) => {
    ...
    const [addGearComment, { error }] = useMutation(ADD_GEAR_COMMENT);
    ...
    const handleFormSubmit = async event => {
        ...
        try {
            ...
            await addGearComment({
                variables: { gearId, commentTitle, commentText },
            });
...
export default GearCommentForm;